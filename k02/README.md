...
79 pNodeを作る
80 必要なメモリの確保をする
81 pNodeのcity部分にnewcityを入れる
82 pNodeのpNext部分に次のNodeのアドレスを入れる
83 pNodeをかえす

108-109 pNodeを作り、pListに入れる
115-118 入力したIDと一致した場合、pCityにpNodeのcity部分を入れ、cnをかえす
120-121 一致しなかった場合、pNodeを次のデータにし、cnに1を足す
124 全部一致しなかったときに-1をかえす
